PROJECT_NAME     := ble_app_soil_sensor_s132
TARGETS          := nrf52832_xxaa
OUTPUT_DIRECTORY := _build

SDK_ROOT := ../../../../SDK/nRF5_SDK_16.0.0
PROJ_DIR := .
...
SRC_FILES += \
  ...
  $(PROJ_DIR)/ble_cus.c \
  $(PROJ_DIR)/timers.c \
  $(PROJ_DIR)/sensors/bat_sensor.c \
  $(PROJ_DIR)/sensors/ec_sensor.c \
  $(PROJ_DIR)/sensors/ntc_temperature_sensor.c \
  $(PROJ_DIR)/sensors/sensors.c \
  $(PROJ_DIR)/button.c \
...
#DISABLE BOOTLOADER CFLAGS += -DNRF_DFU_SVCI_ENABLED
...
#DISABLE BOOTLOADER ASMFLAGS += -DNRF_DFU_SVCI_ENABLED
